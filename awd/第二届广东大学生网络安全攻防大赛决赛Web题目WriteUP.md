...
审计工具结果：  
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815847480-dc8390b0-4e8a-4dfd-9116-9b6288381f36.png)  
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815847377-ee685f67-0c3c-4124-a798-2f0a13a4f9ac.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815847495-e1402e36-285d-4a58-927e-99319436ed1f.png)

#### 漏洞点2：`<font style="color:rgb(199, 37, 78);">minicms\mc-files\mc-core.php</font>`
文件下载功能存在任意文件下载漏洞。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815847413-212aa80c-da6c-48b6-90bb-c49271a600d3.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815847406-87e57f99-0fde-4d8b-af4d-4676ec70eff7.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848015-92087b00-905b-4280-bcc3-d3cd771bb96e.png)

### 题目漏洞挖掘
代码审计工具记录：

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848119-06ecbc41-35ca-46d5-a436-0f11f6456c8a.png)  
D盾查杀情况：

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848117-a05535c5-e2bb-493a-9281-0ca57b5c159c.png)  
河马查杀情况：

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848280-440bc3ed-0b5f-4217-be49-96a95128d436.png)

### 漏洞点1：后台木马文件上传
当时直接找到后台使用弱口令`<font style="color:rgb(199, 37, 78);">admin/000000</font>`进入后台了。一开始我们尝试寻找文件下载、SQL注入、命令/代码执行漏洞，无果。文件上传的地方都是白名单。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848475-c476f894-8866-4930-8cd8-01173818374d.png)  
后面在系统设置中找到了上传配置，这里直接添加`<font style="color:rgb(199, 37, 78);">php</font>`类型，并且把上传文件大小修改成`<font style="color:rgb(199, 37, 78);">5000</font>`。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848717-cd086b41-636f-4449-b066-b41edd9a96eb.png)  
上传PHP木马后将站点源码打包下载到本地进行分析。修复时尝试修改管理员密码还发现无法修改。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815848790-b380cec1-31d5-478c-9e97-45c65ce54669.png)  
从源码上可以看到是设置覆盖默认的。文件：`<font style="color:rgb(199, 37, 78);">app\admin\controller\Upload.php</font>`

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849025-eb823d79-ff16-467c-b962-8c09014c4031.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849788-4b8e44fa-9652-4302-8069-5964004236b6.png)

### 漏洞点2：代码执行漏洞
`<font style="color:rgb(199, 37, 78);">app\index\controller\Form.php</font>`该文件存在 eval 代码执行函数。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849217-858ec382-a8da-4758-b148-929dc0d28acb.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849780-8f747514-29d9-4faa-9534-21cf7a7053ec.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849302-bfad987c-0111-448d-a1b1-205fd19d8627.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815850313-a95961c4-72fe-40ab-97c3-3f61556056fc.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849430-3659580c-4840-4eeb-803b-0032869ad68a.png)  
这里直接用360杀毒都能扫描出来，当然也可以使用D盾、河马WebShell效果差不多。

<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815849672-a503e640-527f-48dc-a2e5-d1774fc8fcdd.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\第二届广东大学生网络安全攻防大赛决赛Web题目WriteUP\1759815850189-7b30e1c3-d316-4c66-a7e3-22377de7a667.png)
