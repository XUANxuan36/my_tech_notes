...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471268841-024f672e-5735-4e44-b1ac-aada74fdaf76.png)

### Post传参
使用bp抓包，添加项目：Content-Type: application/x-www-form-urlencoded

<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269076-c7f4187d-8fea-45da-9ea8-113f27c6022d.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1764902048787-8362d84f-cb58-45f7-8a87-e69aab8c8c87.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269314-37cb3429-18b0-41a4-955e-439d1df518d9.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269486-23ff4d42-8760-45d3-bdc2-8a706f2f94e7.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1761812335673-3654150a-4dd6-4f64-ae74-28b1a7c7bb72.png)  
...
### 空格绕过
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269654-6b37bd2e-915e-47d5-af94-0147e837054e.png)
...
### git泄露
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269788-f4f4f7bf-14f1-4ec7-a8b5-7e407ad79fdd.png)
...
### SSL 证书泄露
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1747968257228-b58d09d7-4d2c-48d3-b69f-d3fb97c73823.png)申请 HTTPS 是需要 SSL 证书的

这个证书可以去在线网站查询的，去这个网站查询域名可以看到证书信息<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1747968311287-8d9b3fd2-ea52-4968-bbbd-85268a1cd601.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1747968452283-e880393d-453c-4d02-8757-e4b5f0d1444b.png)

具体题目提供的时间查找快照

<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1747968516213-1314c321-6f67-450c-a26c-7a7e52a89e3d.png)

### 回溯绕过
parameterLimit选项用于指定query string 或者 request payload的最大数量。 默认情况下，它的值是**1000**。也就是说当url传的值大于一千时，就不会执行admin=false

<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1744471269958-3a77be4d-b164-47fd-828e-1c8fc621b4dc.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1763524480522-ded884ff-1e74-44d5-89de-d4ccac93748c.png)
...
### jwt_GUI
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1761912974641-975d0088-24b7-49d5-b01c-318eeae6674f.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](图片\php\1761913062590-ce59af59-2eaa-4487-962e-84557da0eaab.png)
